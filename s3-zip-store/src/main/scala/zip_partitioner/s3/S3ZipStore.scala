...
object S3ZipStore {
  ...
  def retrieveMultiple(compressedBucket: NonEmptyString, fileKeys: List[NonEmptyString], streamSize: Int = 1024512, s3AsyncClient: S3AsyncClient): fs2.Stream[IO, Byte] =
    withS3(s3AsyncClient).flatMap { s3 =>
